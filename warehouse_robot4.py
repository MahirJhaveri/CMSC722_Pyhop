...
def transport_all2(state, R, container_destination_map):
    if len(state.cargo[R]) == 0 and len(container_destination_map) > 0:
        return [('transport_all_order', R, container_destination_map, 0)]
    return False
...
def transport_all_order1(state, R, container_destination_map, i):
...
def transport_all_order2(state, R, container_destination_map, i):
    if len(state.cargo[R]) == 0 and len(container_destination_map) > 0 and i < len(container_destination_map):
        return [('transport_all_order', R, container_destination_map, i+1)]
    return False
